...
public class MainFrame {
 ...
 //设置主画框的缺省宽度各缺省位置
	private static int width = screenWidth*3/5;
	private static int height = screenHeight*4/5;
	private static int startX = screenWidth/5;
	private static int startY = screenHeight/15;
